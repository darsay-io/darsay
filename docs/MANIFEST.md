...
| `subset.policy` | `"masters"` when the selection was made by the default masters-first classification ([Quantization §4](QUANTIZATION.md#mechanics)); absent for explicit `--include` subsets. Since 1.7.0. |
